...
| `env/room-{castle,cozy,jungle,underwater}.webp` | room 360° backdrops (equirect) | Screaming Brain Studios | [OGA "Cloudy Skyboxes"](https://opengameart.org/content/cloudy-skyboxes-0) — panorama pack | **CC0** — bundled `License.txt`: "released under the CC0/Public Domain License… with or without credit" | Yes | Yes | **Yes** (CC0) | 2026-06-26 | Claude (automated) |
