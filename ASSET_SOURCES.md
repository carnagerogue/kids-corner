...
| `world/map-happy-town.glb` | 3D World preloaded map (cartoon town; kept, currently inactive) | Alex Safayan & Alex Pasquarella | [Poly Pizza](https://poly.pizza/m/baRmeivEYFz) | **CC-BY 3.0** — attribution REQUIRED (credited in the World HUD + here) | Yes | Yes | Yes — ⚠️ **credit required** | 2026-06-27 | Claude (automated) |
...
| `world/house-modern.glb` | Suburb house (2-story) | Kenney (via Poly Pizza) | [Poly Pizza](https://poly.pizza/m/23f5c878) | **CC0** — no attribution required | Yes | Yes | **Yes** | 2026-06-27 | Claude (automated) |
| `world/shop.glb` | Suburb storefront/shop building | Kenney (City Kit, via Poly Pizza) | [Poly Pizza](https://poly.pizza/m/8d947705) | **CC0** — no attribution required | Yes | Yes | **Yes** | 2026-06-27 | Claude (automated) |
