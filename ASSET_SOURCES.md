...
| `world/map-happy-town.glb` | 3D World preloaded map (cartoon town; kept, currently inactive) | Alex Safayan & Alex Pasquarella | [Poly Pizza](https://poly.pizza/m/baRmeivEYFz) | **CC-BY 3.0** — attribution REQUIRED (recorded here; the map is NOT currently rendered, so no in-app credit is shown — re-enabling it MUST restore a visible in-world credit) | Yes | No (inactive) | Yes — ⚠️ **credit required** | 2026-06-27 | Claude (automated) |
| `world/road-kit.glb` | Suburb street tiles (roads, crossroads, crosswalks, sidewalks, street lights) | Kenney (City Kit Roads, via Poly Pizza) | [Poly Pizza](https://poly.pizza/m/YClppstaHV) | **CC0** — no attribution required | Yes | Yes | **Yes** | 2026-06-27 | Claude (automated) |
| `world/house-modern.glb` | Suburb house (2-story) | Kenney (via Poly Pizza) | [Poly Pizza](https://poly.pizza/m/23f5c878) | **CC0** — no attribution required | Yes | No (superseded by CityBuildings + house.glb after the rewrite) | **Yes** | 2026-06-27 | Claude (automated) |
| `world/shop.glb` | Suburb storefront/shop building | Kenney (City Kit, via Poly Pizza) | [Poly Pizza](https://poly.pizza/m/8d947705) | **CC0** — no attribution required | Yes | No (superseded by CityBuildings after the rewrite) | **Yes** | 2026-06-27 | Claude (automated) |
| `world/npcs/kenney-mini/character-{female-d,female-f,male-c,male-e}.glb`, `Textures/colormap.png` | Mayor Nova, Story Keeper, Sky Captain, Maker Buddy | Kenney — Mini Characters 1.0 | [Kenney Mini Characters](https://kenney.nl/assets/mini-characters) | **CC0 1.0** — original `LICENSE.txt` preserved beside assets | Yes | Yes | **Yes** (CC0, no attribution required; credited anyway) | 2026-06-27 | Codex |
| `world/city-modular/{door-brown-window,window-white-wide}.glb`, `Textures/colormap.png` | Hinged city doors and façade windows | Kenney — Modular Buildings 2.1 | [Kenney Modular Buildings](https://kenney.nl/assets/modular-buildings) | **CC0 1.0** — `LICENSE.txt` preserved beside assets | Yes | Yes | **Yes** (CC0, no attribution required; credited anyway) | 2026-06-27 | Codex |
